...
# Buttons for Predict, Update, Save Output
button_frame = tk.Frame(main_frame, bg='white')
button_frame.grid(row=10, column=0, columnspan=2)

predict_button = tk.Button(button_frame, text="Calculate Predicted Position", font=('Helvetica', 12), bg='green', fg='white', command=predict)
predict_button.pack(side=tk.LEFT, padx=10)

association_button = tk.Button(button_frame, text="Calculate Association Probability", font=('Helvetica', 12), bg='silver', fg='white', command=process_measurements)
association_button.pack(side=tk.LEFT, padx=10)

update_button = tk.Button(button_frame, text="Calculate Updated Position", font=('Helvetica', 12), bg='orange', fg='white', command=process_measurements)
