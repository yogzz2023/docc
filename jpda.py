...
def browse_file():
    ...
    if file_path:
        with open(file_path, "r") as file:
            ...
            measurements = []
            for line in lines:
                parts = line.strip().split(',')  # Remove extra whitespace and split by comma
...
tk.Label(main_frame, text="Measurement Data:", font=('Helvetica', 12), bg='white', fg='black').grid(row=8, column=0, sticky="w", pady=5)
