...
tk.Label(main_frame, text="Azimuth (degrees):", font=('Helvetica', 10), bg='white', fg='black').grid(row=10, column=0, sticky="w")
tk.Label(main_frame, text="Elevation (degrees):", font=('Helvetica', 10), bg='white', fg='black').grid(row=11, column=0, sticky="w")
...
tk.Label(main_frame, text="Azimuth (degrees):", font=('Helvetica', 10), bg='white', fg='black').grid(row=10, column=2, sticky="w")
tk.Label(main_frame, text="Elevation (degrees):", font=('Helvetica', 10), bg='white', fg='black').grid(row=11, column=2, sticky="w")
