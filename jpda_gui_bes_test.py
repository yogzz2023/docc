...
def process_data():
    ...
    try:
        ...
        azimuth_1 = math.radians(float(entry_azimuth_1.get()))
        elevation_1 = math.radians(float(entry_elevation_1.get()))
        time_1 = float(entry_time_1.get())

        range_2 = float(entry_range_2.get())
        azimuth_2 = math.radians(float(entry_azimuth_2.get()))
        elevation_2 = math.radians(float(entry_elevation_2.get()))
        time_2 = float(entry_time_2.get())

        # Convert range, azimuth, elevation to x, y coordinates
        m1 = np.array([range_1 * np.cos(azimuth_1) * np.cos(elevation_1), range_1 * np.sin(azimuth_1) * np.cos(elevation_1)])
        m2 = np.array([range_2 * np.cos(azimuth_2) * np.cos(elevation_2), range_2 * np.sin(azimuth_2) * np.cos(elevation_2)])
...
main_frame = tk.Frame(root, bg='Navy Blue')
main_frame.pack(padx=20, pady=20)

# Labels
tk.Label(main_frame, text="Target 1 (x, y):", font=('Helvetica', 12), bg='Navy Blue', fg='white').grid(row=0, column=0, sticky="w", pady=5)
tk.Label(main_frame, text="x:", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=1, column=0, sticky="w")
tk.Label(main_frame, text="y:", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=2, column=0, sticky="w")

tk.Label(main_frame, text="Target 2 (x, y):", font=('Helvetica', 12), bg='Navy Blue', fg='white').grid(row=3, column=0, sticky="w", pady=5)
tk.Label(main_frame, text="x:", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=4, column=0, sticky="w")
tk.Label(main_frame, text="y:", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=5, column=0, sticky="w")

tk.Label(main_frame, text="Pd (Prob. of Detection):", font=('Helvetica', 12), bg='Navy Blue', fg='white').grid(row=6, column=0, sticky="w", pady=5)
tk.Label(main_frame, text="Pfa (Prob. of False Alarm):", font=('Helvetica', 12), bg='Navy Blue', fg='white').grid(row=7, column=0, sticky="w", pady=5)

tk.Label(main_frame, text="Measurement 1:", font=('Helvetica', 12), bg='Navy Blue', fg='white').grid(row=8, column=0, sticky="w", pady=5)
tk.Label(main_frame, text="Range:", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=9, column=0, sticky="w")
tk.Label(main_frame, text="Azimuth (degrees):", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=10, column=0, sticky="w")
tk.Label(main_frame, text="Elevation (degrees):", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=11, column=0, sticky="w")
tk.Label(main_frame, text="Time (ms):", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=12, column=0, sticky="w")

tk.Label(main_frame, text="Measurement 2:", font=('Helvetica', 12), bg='Navy Blue', fg='white').grid(row=8, column=2, sticky="w", pady=5)
tk.Label(main_frame, text="Range:", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=9, column=2, sticky="w")
tk.Label(main_frame, text="Azimuth (degrees):", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=10, column=2, sticky="w")
tk.Label(main_frame, text="Elevation (degrees):", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=11, column=2, sticky="w")
tk.Label(main_frame, text="Time (ms):", font=('Helvetica', 10), bg='Navy Blue', fg='white').grid(row=12, column=2, sticky="w")
...
button_frame = tk.Frame(main_frame, bg='Navy Blue')
...
association_button = tk.Button(button_frame, text="Calculate Association Probability", font=('Helvetica', 12), bg='silver', fg='white', command=process_data)
...
save_button = tk.Button(button_frame, text="Save Output", font=('Helvetica', 12), bg='red', fg='white', command=save_output)
...
output_text = scrolledtext.ScrolledText(output_frame, width=120, height=10, font=('Helvetica', 10), bg='black', fg='white')
output_text.pack()
